...
_yoyo_dir = _script_dir.parent
workspace = _yoyo_dir / "output" / "main-original"
workspace.mkdir(parents=True, exist_ok=True)

ball_obj = _yoyo_dir / "yoyo-ball.obj"
string_obj = _yoyo_dir / "yoyo-string.obj"
...
HookeanSpring().apply_to(string_mesh, 500.0 * MPa, thickness=0.0006, mass_density=300.0)
