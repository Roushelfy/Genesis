...
def default_paths() -> tuple[Path, Path, Path, Path, Path, Path]:
    ...
    warmup_joint_json = repo_root / "DemoAssets" / "kimono" / "scripts" / "results" / "v1" / "joint_pose.json"
    cloth_obj = (
        repo_root / "DemoAssets" / "kimono" / "scripts" / "results" / "v1" / "wearing_cloth_0_init-shape_fixed.obj"
    )
    rest_cloth_obj = (
        repo_root / "DemoAssets" / "kimono" / "scripts" / "results" / "v1" / "wearing_cloth_0_rest-shape.obj"
    )
