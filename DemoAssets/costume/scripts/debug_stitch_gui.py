"""Debug scene: only kimono_inner_lower + kimono_inner_upper with stitch, no robot, no collision.

Usage::

    uv run python debug_stitch_gui.py
"""
...
OUTPUT_DIR = REPO_ROOT / "DemoAssets" / "costume" / "output" / "debug_stitch"
...
def main() -> None:
    ...
    stitch_pairs: np.ndarray | None = None
    stitch_slot_a = None
    stitch_slot_b = None
    stitch_faces_b: np.ndarray | None = None
