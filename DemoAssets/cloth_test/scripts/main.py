        ...
        try:
            ...
            for geo_key, geo_val in geo_items:
                ...
                if tri_attr is None:
                    ...
                    print(f"[sanity-fix] geometry={geo_key} triangle original_index count={valid.size}")
                ...
                if str(geo_key) == "close_mesh":
                    ...
                    if v_attr is not None:
                        ...
                        print(f"[sanity-fix] geometry={geo_key} vertex original_index count={v_valid.size}")
                print(
