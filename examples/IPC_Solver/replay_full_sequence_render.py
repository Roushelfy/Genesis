"""
Replay the stitched full gear sequence — Sharpa hands, high-quality render.
...
Usage
-----
    python examples/IPC_Solver/replay_full_sequence_render.py [OPTIONS]
...
class FullSequenceRender(TrajectoryReplay):
    name = "gear_full"
    cam_pos = (0.5, -0.8, 1.3)
    cam_lookat = (CX, CY, CZ)
    cam_fov = 40
