...
class RigidSolver(Solver):
    ...
    # IPC object management is now handled by IPCCoupler



    # IPC state retrieval is now handled by IPCCoupler
    ...
    def substep_pre_coupling(self, f):
        if self.is_active():
            # For IPCCoupler, skip rigid body computation in pre-coupling phase
