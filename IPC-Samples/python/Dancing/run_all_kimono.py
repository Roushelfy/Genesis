...
OUTPUT_BASE = REPO_ROOT / "IPC-Samples" / "output" / "python" / "Dancing" / "g1_kimono_batch"
...
TASKS: list[tuple[int, bool]] = [
    (0, True), (2, True), (4, True), (5, True), (1, True),   # no_lower
    (0, False), (2, False), (4, False), (5, False),           # lower (d1_lower abandoned)
]
